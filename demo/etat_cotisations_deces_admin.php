...
if (isset($_POST['vbtn'])) {
    ...
    for ($i = 0; $i < sizeof($results); $i++) {
        ...
        $temp_array['commune'] = $results[$i]['NOM_COMMUNE'];
    ...
    if (isset($_POST['annee'])) {
        ...
        fputs($etat, utf8_decode("N°\tCommune\tCotisation hommes\tCotisation femmes\tTotal par déces\n"));
    }
}
?>
<!DOCTYPE html>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($defunts as $defunt) {
                                                    fputs($etat, $i . "\t" . $defunt['commune'] . "\t" . (!isset($defunt['homme']) ? 0 : $defunt['homme']) . "\t" . (!isset($defunt['femme']) ? 0 : $defunt['femme']) . "\t" . ((!isset($defunt['homme']) ? 0 : $defunt['homme']) + (!isset($defunt['femme']) ? 0 : $defunt['femme'])) . "\n");
